...
{
    public partial class ElectricityPlansUserControl : System.Web.UI.UserControl
    {
        private readonly ElectricityPlanRepositoryInMemory _repository;

        public string ElectricUses { get; private set; }
        public string RateType { get; private set; }
        public string RateDetails { get; private set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // 속성에 선택한 값 담기
            ElectricUses = ddlElectricUses.SelectedValue;
            RateType = ddlRateType.SelectedValue;
            RateDetails = ddlRateDetails.SelectedValue; 
        }
